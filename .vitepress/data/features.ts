...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    status: 'draft',
    note: {
      en: 'Enter and exit events for an area. The area grammar exists now; the command itself is unbuilt and still depends on continuous background positioning.',
      sk: 'Udalosti vstupu a odchodu pre oblasť. Gramatika oblastí už existuje; sám príkaz postavený nie je a stále závisí od nepretržitého určovania polohy na pozadí.',
    },
