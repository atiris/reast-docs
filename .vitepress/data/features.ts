...
export const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    group: 'storylets',
    syntax: '{face vertical="60%" begin} **1 gold** {end face}',
    status: 'experimental',
    since: '1.4',
    note: {
  ...
  },
  {
    ...
    group: 'storylets',
    syntax: '{layer image="assets/shield.webp", vertical="20%", horizontal="80%", width="18%"}',
    status: 'experimental',
    since: '1.6',
    note: {
      ...
      sk: 'Obrázok navrstvený na kresbu karty. Viac vrstiev aj text líca tvoria jednu kartu: otáčajú sa, zväčšujú a animujú spolu. Pozície sú percentá karty, takže prekrytie padne na to isté miesto na náhľade aj na celej obrazovke; ako je vrstva krycia, patrí obrázku, a klauzula `when` je to, čo prekrytie zapne — štít sa objaví, keď ho čitateľ má.',
    },
    link: '/spec/storylets',
  },
  {
  ...
  },
  {
    ...
    group: 'cards',
    syntax: 'weight=3 · home=@(48.14, 17.10) · story.card.lantern.weight',
    status: 'experimental',
    since: '1.5',
    note: {
      en: 'An unquoted card attribute that is a complete Rea literal carries a real number, boolean, point or array, read back as story.card.<id>.<prop>. Quoting keeps a value as display text, so the two readings never overlap. The mirror is read-only and holds typed properties only.',
      sk: 'Atribút karty bez úvodzoviek, ktorý je úplným literálom jazyka Rea, nesie skutočné číslo, pravdivostnú hodnotu, bod alebo pole a číta sa späť ako story.card.<id>.<prop>. Úvodzovky nechajú hodnotu zobrazovaným textom, takže sa obe čítania nikdy neprekrývajú. Kópia je iba na čítanie a drží len typované vlastnosti.',
    },
