...
### Kategórie chýb {#error-categories}

Rea rozlišuje tri kategórie chýb:

| Kategória              | Kedy sa zistí        | Príklady                                                                                        |
| ---------------------- | -------------------- | ------------------------------------------------------------------------------------------------- |
| **Chyba parsovania**   | Pred vykonaním       | Syntaktické chyby, neuzavreté bloky, chybné metadáta, neplatné vnorenie                         |
| **Chyba za behu**      | Počas vykonávania    | Nedefinovaná premenná, delenie nulou, chýbajúci cieľ odbočky, limit rekurzie                    |
| **Chyba prostredia**   | Počas vykonávania    | Chýbajúci mediálny súbor, nedostupný senzor, zlyhanie siete                                     |

Chyby parsovania sa vždy hlásia pred spustením príbehu (v prísnom režime) alebo sa ticho zaplátajú (v elegantnom režime). Chyby za behu a chyby prostredia nastávajú počas vykonávania príbehu a podliehajú elegantnej degradácii.

Rea **nemá** `try/catch`. Všetko spracovanie chýb je implicitné — runtime sa ticho zotaví a zážitok čitateľa sa nikdy nepreruší. Autori chyby vidia počas testovania (prísny režim); čitatelia nikdy.

### Elegantný režim (predvolený) {#graceful-mode-default}

<Feature id="error-handling" />

Predvolene Rea zlyháva elegantne — zážitok čitateľa sa nikdy nerozbije:

| Chyba                                 | Elegantné správanie                                                                                                |
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| Nedefinovaná premenná `{gold}`        | Vykreslí sa ako prázdny reťazec (nič sa nezobrazí)                                                                 |
| Neplatný výraz `{1 / 0}`              | Ticho sa preskočí                                                                                                  |
| Chýbajúci obrázok                     | Zobrazí sa zástupný obsah s alternatívnym textom                                                                   |
| Chýbajúci zvuk                        | Ticho sa preskočí, príbeh pokračuje                                                                                |
| Chýbajúce video                       | Zobrazí sa náhľadový snímok, ak je k dispozícii, inak zástupný obsah                                               |
| Chýbajúci hlas alebo syntéza reči     | Ticho sa preskočí                                                                                                  |
| Neuzavretý blok `{if begin}` na konci súboru | Automaticky sa uzavrie na konci súboru                                                                      |
