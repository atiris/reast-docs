...
- **Multimédiá ako súčasť jazyka** — obrázky, audio, video a hlasový výstup nie sú doplnky, ale natívne prvky syntaxe.
- **Kooperatívne čítanie** — viacerí čitatelia môžu zdieľať ten istý príbeh v reálnom čase, každý so svojím pohľadom.
- **Interakcie s reálnym svetom** — GPS, QR kódy, senzory zariadenia a časovače otvárajú príbehy do fyzického prostredia.
- **Prístupnosť od základov** — podpora čítačiek obrazovky, navigácia klávesnicou a alternatívny text sú zabudované priamo v syntaxi.
